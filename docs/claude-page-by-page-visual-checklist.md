...
| --- | --- | --- | --- | ---: | --- |
| 01-square | `artifacts\screenshots\claude-after\01-square.png` | `design_refs/front/01-square.png` | `artifacts\diffs\claude-front\01-square.diff.png` | 13.46% | 可接受但仍需局部微调 |
| 02-mood-create | `artifacts\screenshots\claude-after\02-mood-create.png` | `design_refs/front/02-mood-create.png` | `artifacts\diffs\claude-front\02-mood-create.diff.png` | 16.69% | 需继续修复 |
| 03-post-detail | `artifacts\screenshots\claude-after\03-post-detail.png` | `design_refs/front/03-post-detail.png` | `artifacts\diffs\claude-front\03-post-detail.diff.png` | 13.92% | 可接受但仍需局部微调 |
| 04-post-detail-reply-sheet | `artifacts\screenshots\claude-after\04-post-detail-reply-sheet.png` | `design_refs/front/04-post-detail-reply-sheet.png` | `artifacts\diffs\claude-front\04-post-detail-reply-sheet.diff.png` | 11.35% | 可接受但仍需局部微调 |
| 05-letter-today | `artifacts\screenshots\claude-after\05-letter-today.png` | `design_refs/front/05-letter-today.png` | `artifacts\diffs\claude-front\05-letter-today.diff.png` | 16.41% | 需继续修复 |
| 06-tool-index | `artifacts\screenshots\claude-after\06-tool-index.png` | `design_refs/front/06-tool-index.png` | `artifacts\diffs\claude-front\06-tool-index.diff.png` | 14.55% | 可接受但仍需局部微调 |
...
| 14-feedback-help | `artifacts\screenshots\claude-after\14-feedback-help.png` | `design_refs/front/14-feedback-help.png` | `artifacts\diffs\claude-front\14-feedback-help.diff.png` | 18.20% | 需继续修复 |
