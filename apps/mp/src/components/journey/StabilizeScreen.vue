...
<style scoped>
.stabilize-screen{display:grid;gap:11px}.comfort-note{display:grid;grid-template-columns:43px minmax(0,1fr);gap:12px;border-radius:23px;background:linear-gradient(145deg,#fffdf7,#f3ecdd);padding:19px 17px;box-shadow:0 15px 32px rgba(20,32,27,.11)}.comfort-mark,.support-icon{display:grid;place-items:center;border-radius:50%;background:#e9eedf;color:#52714d}.comfort-mark{width:41px;height:41px}.comfort-note p{margin:1px 0 5px;color:#69805f;font-size:13px}.comfort-note strong{color:#384f3a;font-size:17px;font-weight:600;line-height:1.55}.stabilize-options{display:grid;gap:9px}.support-option,.write-option{position:relative;display:grid;grid-template-columns:44px minmax(0,1fr) 20px;gap:11px;align-items:center;width:100%;min-height:78px;border:1px solid rgba(95,127,62,.14);border-radius:20px;background:linear-gradient(135deg,rgba(255,253,247,.98),rgba(247,243,231,.96));padding:13px;color:#2f4532;text-align:left;font:inherit;box-shadow:0 9px 19px rgba(48,59,40,.05);cursor:pointer}.support-option>span:nth-child(2),.write-option>span:nth-child(2){min-width:0}.support-icon{width:42px;height:42px;box-shadow:0 4px 10px rgba(73,101,63,.07)}.support-option strong,.support-option small,.write-option strong{display:block}.support-option strong,.write-option strong{font-size:16px}.support-option small{margin-top:4px;color:#788078;font-size:12px;line-height:1.45}.support-option>svg{color:#75846d}.support-option:disabled{opacity:.6;cursor:wait}.write-option{grid-template-columns:44px minmax(0,1fr) auto;cursor:default}.write-option input{width:100%;margin-top:7px;border:1px solid rgba(95,127,62,.18);border-radius:9px;background:#fffefa;padding:7px 8px;color:#324633;font:inherit}.write-option button{border:0;border-radius:10px;background:#5b7c54;padding:8px 10px;color:#fff;font:inherit;cursor:pointer}.write-option button:disabled{opacity:.5;cursor:wait}.status{margin:0;border-radius:12px;background:#eef3e7;padding:10px;color:#506a46;font-size:13px}.handoff-note{position:relative;display:flex;align-items:center;gap:9px;min-height:61px;overflow:hidden;border-radius:16px;background:linear-gradient(90deg,#eff0de,#e6eadd);padding:12px 111px 12px 12px;color:#54704d}.handoff-note::after{position:absolute;right:0;bottom:0;width:150px;height:61px;background:url('../../assets/goodnight/illustrations/stabilize-handoff-scene.png') right bottom/contain no-repeat;content:'';opacity:.84;pointer-events:none}.handoff-note>*{position:relative;z-index:1}.handoff-note p{margin:0;font-size:13px;line-height:1.55}.stabilize-actions{display:grid;gap:5px;padding:0 12px}.handoff-button,.change-support{min-height:47px;border-radius:999px;padding:10px;font:inherit;cursor:pointer}.handoff-button{border:0;background:#416a50;color:#fff;box-shadow:0 11px 20px rgba(44,83,58,.18)}.change-support{min-height:34px;border:0;background:transparent;color:#5d7555;font-size:13px}
</style>
