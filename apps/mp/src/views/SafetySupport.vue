...
.safety-hero{min-height:178px}.safety-hero p{position:absolute;top:25px;left:70px;margin:0}.safety-hero h1{max-width:318px;margin:20px 0 4px;font-size:25px}.safety-hero span{max-width:300px}</style>
