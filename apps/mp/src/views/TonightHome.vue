...
.night-hero{min-height:178px;width:calc(100% + 28px);max-width:none}.entry-card{margin-top:-10px}.active-journey{min-height:78px;padding:12px 14px}.active-journey small{display:-webkit-box;overflow:hidden;-webkit-box-orient:vertical;-webkit-line-clamp:1}.quiet-note{padding:10px 12px}.quiet-note p{font-size:14px}</style>
