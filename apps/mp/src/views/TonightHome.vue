...
<style scoped>
.tonight-page{display:grid;gap:14px;padding:0 14px 144px;background:#f6f1e5}.night-hero{position:relative;min-height:194px;margin:0 -14px;overflow:hidden;padding:18px 22px;background:radial-gradient(circle at 74% 67%,rgba(238,176,127,.46),transparent 25%),linear-gradient(165deg,#101d2a 0%,#243747 47%,#6e665b 100%)}.night-hero::after{position:absolute;right:-8px;bottom:-18px;width:205px;height:205px;background:url('../assets/goodnight/tree-top-cutout.png') right bottom/contain no-repeat;opacity:.45;content:'';pointer-events:none;filter:saturate(.74) brightness(.72)}.night-hero::before{position:absolute;inset:0;background:radial-gradient(circle at 85% 20%,#f8e5a3 0 3px,transparent 4px),radial-gradient(circle at 60% 13%,rgba(255,255,255,.75) 0 1px,transparent 2px),radial-gradient(circle at 25% 36%,rgba(255,255,255,.5) 0 1px,transparent 2px);content:'';pointer-events:none}.hero-top,.hero-copy{position:relative;z-index:1}.hero-top{display:flex;align-items:center;justify-content:space-between;color:#f9f5e8}.brand{display:flex;align-items:center;gap:6px;font-size:14px}.notice-button{position:relative;display:grid;place-items:center;width:34px;height:34px;min-height:34px;border:0;background:transparent;color:#f8f4e6;cursor:pointer}.notice-button b{position:absolute;right:-5px;top:-4px;min-width:17px;border-radius:9px;background:#bf6757;padding:2px;color:#fff;font-size:10px;text-align:center}.hero-copy{margin-top:38px}.hero-copy h1{margin:0;color:#fffaf0;font-family:"Songti SC","Noto Serif SC","Source Han Serif SC",serif;font-size:33px;line-height:1.18}.hero-copy p{margin:8px 0 0;color:rgba(255,250,240,.8);font-size:14px}.entry-card{display:grid;gap:10px;margin-top:-20px;border-radius:25px;background:rgba(255,253,247,.97);padding:19px;box-shadow:0 17px 36px rgba(25,38,42,.19)}.entry-card label{display:grid;gap:10px;color:#697a5c;font-size:14px}.entry-card textarea{min-height:158px;width:100%;border:1px solid rgba(98,126,79,.15);border-radius:14px;background:#fffdfa;padding:13px;color:#334036;font:inherit;line-height:1.7;resize:none}.entry-footer{display:flex;align-items:center;justify-content:space-between;color:#899083;font-size:12px}.entry-footer span{display:flex;align-items:center;gap:5px}.shortcut-row{display:flex;gap:8px;overflow-x:auto;padding:2px 2px 7px;scrollbar-width:none}.shortcut-row::-webkit-scrollbar{display:none}.shortcut-row button{flex:0 0 auto;min-height:38px;border:1px solid rgba(95,127,62,.16);border-radius:999px;background:#fffdf8;padding:8px 14px;color:#586e50;font:inherit;white-space:nowrap;cursor:pointer}.shortcut-row button.selected{border-color:#4e704d;background:#4e704d;color:#fff}.active-journey{display:flex;align-items:center;justify-content:space-between;gap:12px;border-radius:18px;background:#fffdf8;padding:15px 16px;box-shadow:0 8px 18px rgba(44,58,42,.08)}.active-journey p,.active-journey small{display:block;margin:0;color:#7a8177;font-size:12px}.active-journey strong{display:block;margin:4px 0;color:#2d4330}.active-journey button{border:0;background:transparent;color:#4b6a46;font:inherit;cursor:pointer}.quiet-note{display:flex;gap:10px;align-items:center;border-radius:17px;background:linear-gradient(120deg,#e6eadb,#f3eee1);padding:14px;color:#566b4d}.quiet-note span{display:grid;place-items:center;width:29px;height:29px;border-radius:50%;background:#587854;color:#fff}.quiet-note p{margin:0;line-height:1.55}.continue-button{min-height:51px;border:0;border-radius:999px;background:#496d49;color:#fff;font:inherit;box-shadow:0 12px 23px rgba(44,76,48,.24);cursor:pointer}.continue-button:disabled{opacity:.6;cursor:wait}.error-text{margin:0;color:var(--gn-danger)}.loading-note{margin:0;padding:20px;color:#65745e;text-align:center}.sheet-mask{position:fixed;inset:0;z-index:60;display:flex;align-items:flex-end;background:rgba(8,18,22,.52)}.relation-sheet{display:grid;gap:18px;width:min(430px,100vw);max-height:78vh;overflow:auto;border-radius:26px 26px 0 0;background:#fffaf1;padding:14px 18px calc(24px + env(safe-area-inset-bottom));box-shadow:0 -18px 46px rgba(0,0,0,.25)}.sheet-handle{justify-self:center;width:48px;height:5px;border-radius:999px;background:rgba(60,71,57,.22)}.relation-sheet header{display:flex;align-items:start;justify-content:space-between;gap:12px}.relation-sheet h2{margin:0;color:#304930;font-size:21px;line-height:1.4}.relation-sheet header button{width:30px;height:30px;border:0;border-radius:50%;background:#edf1e4;color:#405c3d;font-size:20px;cursor:pointer}.relation-list{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px}.relation-list button,.relation-other{min-height:48px;border:1px solid rgba(95,127,62,.18);border-radius:14px;background:#fffdf8;padding:10px;color:#4a6442;font:inherit;cursor:pointer}.relation-list button.selected{background:#5a7b51;color:#fff}.relation-other{background:transparent}@media(max-width:350px){.relation-list{grid-template-columns:1fr}.hero-copy h1{font-size:31px}}
.night-hero{min-height:176px;width:calc(100% + 28px);max-width:none}.hero-copy{margin-top:31px}.entry-card{gap:8px;margin-top:-10px;padding:16px}.entry-card textarea{min-height:128px}.active-journey{min-height:0;border:1px solid rgba(95,127,62,.1);border-radius:16px;background:rgba(255,253,248,.8);padding:9px 12px;box-shadow:0 6px 13px rgba(44,58,42,.05)}.active-journey p,.active-journey small{display:none}.active-journey strong{max-width:274px;overflow:hidden;margin:0;color:#40553f;font-size:13px;line-height:1.35;text-overflow:ellipsis;white-space:nowrap}.active-journey button{font-size:13px}.shortcut-row{gap:7px;padding-bottom:4px}.shortcut-row button{min-height:36px;padding:7px 13px}.quiet-note{position:relative;min-height:50px;overflow:hidden;padding:10px 76px 10px 12px}.quiet-note::after{position:absolute;right:0;bottom:-8px;width:92px;height:70px;background:url('../assets/goodnight/illustrations/situation-book-lantern.png') right bottom/contain no-repeat;content:'';opacity:.64;pointer-events:none}.quiet-note span,.quiet-note p{position:relative;z-index:1}.quiet-note p{font-size:14px}.continue-button{min-height:50px}</style>
