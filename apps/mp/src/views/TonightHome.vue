...
.night-hero{min-height:178px;width:calc(100% + 28px);max-width:none}.entry-card{margin-top:-10px}.active-journey{min-height:0;border:1px solid rgba(95,127,62,.1);border-radius:16px;background:rgba(255,253,248,.8);padding:9px 12px;box-shadow:0 6px 13px rgba(44,58,42,.05)}.active-journey p,.active-journey small{display:none}.active-journey strong{max-width:274px;overflow:hidden;margin:0;color:#40553f;font-size:13px;line-height:1.35;text-overflow:ellipsis;white-space:nowrap}.active-journey button{font-size:13px}.quiet-note{padding:10px 12px}.quiet-note p{font-size:14px}</style>
