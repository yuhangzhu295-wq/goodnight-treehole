...
<style scoped>
.peer-network-page{display:grid;gap:14px;padding:0 16px 142px;background:linear-gradient(180deg,#18313a 0 188px,#fbf8ef 188px)}
.peer-hero{position:relative;min-height:177px;margin:0 -16px;padding:19px 25px;overflow:hidden;color:#f7f2df;background:linear-gradient(135deg,#152b33,#29464a 62%,#4a624e)}.hero-top,.peer-hero h1,.peer-hero p{position:relative;z-index:1}.hero-top{display:flex;justify-content:space-between;font-size:12px}.hero-mark{padding:4px 9px;border:1px solid rgba(255,255,255,.32);border-radius:999px}.peer-hero h1{margin:29px 0 7px;max-width:218px;font-family:var(--gn-font-display);font-size:30px;line-height:1.17}.peer-hero p{max-width:258px;margin:0;color:#e1e8d2;font-size:13px;line-height:1.65}.peer-tabs{display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-top:-7px;padding:6px;border:1px solid var(--gn-border);border-radius:999px;background:rgba(255,255,255,.91);box-shadow:var(--gn-shadow-card)}.peer-tabs button{min-height:42px;border:0;border-radius:999px;background:transparent;color:var(--gn-subtext);font:inherit;cursor:pointer}.peer-tabs .active{background:var(--gn-green);color:#fff}.state-note,.empty-note{margin:34px 10px;color:var(--gn-subtext);line-height:1.7;text-align:center}.error-note{margin:0;color:var(--gn-danger);text-align:center}.boundary-card,.peer-story-card,.public-block{border:1px solid var(--gn-border);border-radius:22px;background:var(--gn-card);box-shadow:var(--gn-shadow-card)}.boundary-card{padding:24px;text-align:center}.boundary-card h2{margin:8px 0;color:var(--gn-green-dark)}.boundary-card p{margin:0;color:var(--gn-subtext);line-height:1.7}.boundary-card button,.story-footer button{min-height:44px;border:0;border-radius:999px;background:var(--gn-green);color:#fff;font:inherit;cursor:pointer}.boundary-card button{width:100%;margin-top:18px}.leaf-glyph,.row-sprout{color:var(--gn-green);font-size:24px}.recommend-block{display:grid;gap:11px}.section-heading{display:flex;align-items:end;justify-content:space-between;gap:12px;padding:2px 4px}.section-heading span{color:var(--gn-green);font-size:12px}.section-heading h2{margin:4px 0 0;color:var(--gn-text);font-size:19px}.section-heading button{border:0;background:transparent;color:var(--gn-green);font:inherit;cursor:pointer}.peer-story-card{position:relative;padding:16px;overflow:hidden}.peer-story-card::after{position:absolute;right:-7px;bottom:-6px;width:135px;height:105px;background:url('../assets/goodnight/peer/peer-bench-scene.png') right bottom/contain no-repeat;content:'';opacity:.42;pointer-events:none}.story-top,.reason,.story-footer{position:relative;z-index:1}.story-top{display:flex;align-items:center;gap:10px}.anonymous-dot{display:grid;place-items:center;width:36px;height:36px;border-radius:50%;background:var(--gn-green-light);color:var(--gn-green)}.story-top div{display:grid;gap:3px;min-width:0}.story-top strong{color:var(--gn-text)}.story-top small,.public-row small{color:var(--gn-subtext);font-size:12px}.later-pill{margin-left:auto;padding:4px 8px;border-radius:999px;background:#f5eed8;color:#806d3f;font-size:11px}.reason{max-width:290px;margin:13px 0;color:var(--gn-text);font-size:14px;line-height:1.66}.story-footer{display:flex;align-items:center;justify-content:space-between;gap:12px;padding-top:11px;border-top:1px solid var(--gn-border)}.story-footer span{color:var(--gn-subtext);font-size:12px}.story-footer button{padding:0 13px;font-size:12px}.public-block{display:grid;gap:0;padding:17px}.public-row{display:grid;grid-template-columns:34px minmax(0,1fr)18px;align-items:center;gap:8px;width:100%;padding:14px 0;border:0;border-bottom:1px solid var(--gn-border);background:transparent;text-align:left;cursor:pointer}.public-row:last-of-type{border-bottom:0}.public-row span:nth-child(2){display:grid;gap:4px}.public-row strong{color:var(--gn-text)}.public-row b{color:var(--gn-green);font-size:24px;font-weight:400}.limit-note{margin:14px 0 0;color:var(--gn-subtext);font-size:12px;text-align:center}
...
.peer-hero::after{position:absolute;right:0;bottom:0;width:214px;height:154px;background:url('../assets/goodnight/peer/peer-night-hero.png') right bottom/auto 154px no-repeat;content:'';opacity:.94;pointer-events:none;-webkit-mask-image:linear-gradient(90deg,transparent 0%,#000 34%,#000);mask-image:linear-gradient(90deg,transparent 0%,#000 34%,#000)}
.peer-network-page{align-content:start}
</style>
